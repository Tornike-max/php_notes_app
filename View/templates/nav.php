            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if (!isset($_SESSION['user'])): ?>
                            <a href="/users/create" class="rounded-md <?= $_SERVER['REQUEST_URI'] === '/users/create' ? 'bg-gray-900 text-white' : 'hover:bg-gray-700 text-gray-300 ' ?>  px-3 py-2 text-sm font-medium " aria-current="page">Register</a>
                            <a href="/session/login" class="rounded-md px-3 py-2 text-sm font-medium <?= $_SERVER['REQUEST_URI'] === '/session/login' ? 'bg-gray-900 text-white' : 'hover:bg-gray-700 text-gray-300 ' ?>">Login</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
