            ...
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="w-full m-auto flex justiify-center items-center flex-col mt-10 gap-x-6 gap-y-86">
                        <div class="w-full">
                            ...
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input value="<?= $_POST['name'] ?? '' ?>" type="text" name="name" id="name" class="block flex-1 border-0 bg-transparent py-2 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" />
                                </div>
                                <?php if (isset($errors['name'])) : ?>
                                    <span class="text-red-500 text-sm"><?= $errors['name']['message'] ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Confirm password</label>
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input type="password" name="password_confirmation" id="password_confirmation" class="block flex-1 border-0 bg-transparent py-2 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" />
                                </div>
                                <?php if (isset($errors['password_confirmation'])) : ?>
                                    <span class="text-red-500 text-sm"><?= $errors['password_confirmation']['message'] ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
