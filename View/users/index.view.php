    ...
    <table class="w-full">
        <thead class="w-full bg-gray-100">
            <tr class="w-full text-lg">
                ...
                <th class="text-start px-2">Created at</th>
            ...
            <?php foreach ($users as $user): ?>
                <tr class="bg-gray-200 border-b border-gray-500">
                    ...
                    <td class="py-2 px-2 flex items-center gap-2">
                        <a href="/users/show?id=<?= $user['id'] ?>" class="py-2 px-3 rounded-md bg-indigo-500 hover:bg-indigo-600 text-white duration-150 transition-all">Show</a>
